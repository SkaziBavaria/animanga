const SHELL_CACHE = 'animanga-shell-v38';
const API_CACHE = 'animanga-api-v7';
const ASSETS = [
  '/', '/index.html', '/styles.css', '/manifest.webmanifest', '/icon.svg', '/animanga-logo.png',
  '/js/app.js?v=20260915-1', '/js/api.js', '/js/aniskip.js', '/js/details.js', '/js/discover.js',
  ...
  '/js/player-gestures.js', '/js/player-nav.js', '/js/player-viewport.js', '/js/progress.js', '/js/release-watches.js', '/js/shows.js',
