  ...
  try {
    for (const bundle of bundles || []) {
      ...
      for (const record of bundle.records) {
        if (!['show', 'tracking', 'custom_name', 'archive', 'watch', 'position', 'setting', 'settings', 'manga', 'manga_tracking', 'manga_archive', 'manga_read', 'manga_position'].includes(record.kind) || !record.key || !record.updatedAt || !record.deviceId) continue;
