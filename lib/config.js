...
const ANIDB_ORIGIN = String(process.env.ANIMANGA_ANIDB_ORIGIN || 'https://anidb.app').replace(/\/$/, '');
const ANIDB_REFERER = `${ANIDB_ORIGIN}/`;
const CURL_IMPERSONATE = String(process.env.ANIMANGA_CURL_IMPERSONATE || '').trim();
const COMICK_API = String(process.env.ANIMANGA_COMICK_API || 'https://api.comick.dev').replace(/\/$/, '');
const MANGADEX_API = String(process.env.ANIMANGA_MANGADEX_API || 'https://api.mangadex.org').replace(/\/$/, '');
