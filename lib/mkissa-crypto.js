...
// Mid bundle: Ba=fn(n)!=="string"?"mask":"",ln="64"
const MASK_TERNARY_WITH_BUILD_REGEX = /!==["']string["']\?["']([0-9a-fA-F]{64})["']:["']["']\s*,\s*[A-Za-z_$][\w$]*=["'](\d+)["']/g;
// Current bundle: qa=fn(n)!=="string"?"mask":"",gr=fn(n)!=="string"?"65":""
