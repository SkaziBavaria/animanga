...
const { ACCESS_TOKEN, DATA_DIR, DEFAULT_MEDIA_REFERER } = require('./config');
...
function buildProxyPath(targetUrl, referrer = DEFAULT_MEDIA_REFERER, { ttlSeconds = PROXY_TTL_MEDIA_SECONDS } = {}) {
